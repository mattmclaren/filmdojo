...
<!-- Mirrored from 7.pdvop2sz.z8.ru/highland/1.4/blog-timeline.php by HTTrack Website Copier/3.x [XR&CO'2013], Sat, 15 Mar 2014 23:21:38 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>The Highland Template - Blog Timeline</title>
            ...
            <li class="dropdown hidden-sm">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Gallery <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="gallery-text.php">Gallery Text Blocks</a></li>
                  <li><a href="gallery-bubbles.php">Gallery Bubbles</a></li>
                  <li><a href="gallery-item.php">Gallery Items</a></li>
                </ul>
            </li>
        ...
        <div class="col-sm-8">
          ...
          <!-- First blog post -->
            <div class="blog-summary">
              <h4 class="new-story"><a href="blog-post.php">HighLand - a new responsive Bootstrap 3 template</a></h4>
            ...
            <!-- Second blog post -->
            <div class="blog-summary">
              <h4><a href="blog-post.php">Lorem ipsum dolor sit amet, consectetur adipiscing elit</a></h4>
            ...
            <!-- Third blog post -->
            <div class="blog-summary">
              <h4><a href="blog-post.php">Nulla dapibus lorem sed felis placerat fringilla</a></h4>
              <time datetime="2013-08-10" class="timestamp hidden-xs">Nov 08, 2013</time>
              <ul class="text-muted list-inline">
                <li><i class="fa fa-user"></i> <a href="profile.php">Administrator</a></li>
