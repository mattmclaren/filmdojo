...
<!-- Mirrored from 7.pdvop2sz.z8.ru/highland/1.4/edit-profile.php by HTTrack Website Copier/3.x [XR&CO'2013], Sat, 15 Mar 2014 23:21:45 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>The Highland Template - Edit Profile</title>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-md-3">
          <div class="user-menu bottom-15">
            <ul>
              ...
              <li>
                <a href="edit-profile.php" class="active">
        ...
        <div class="col-sm-8 col-md-6">
          <!-- Edit profile form -->
          <h3 class="hl">Edit profile <small>Alex Smith</small></h3>
          ...
          <form role="form">
            ...
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="email-1" placeholder="Enter new email">
            </div>
            <div class="form-group">
              <label for="pwwd">Password</label>
              <input type="password" class="form-control" id="pwwd" placeholder="Enter new password">
            </div>
            <div class="form-group">
          ...
          <h4 class="hl bottom-15">Profile Settings</h4>
          <hr>
          <form role="form">
            <div class="form-group">
              ...
              <div class="checkbox">
                <label>
                  <input type="checkbox"> Check if you don't want to receive notifications
                </label>
              </div>
            </div>
            <hr>
            <div class="form-group">
              <label>Accept e-mails</label>
              <p class="text-muted">Do you want to receive email from other users?</p>
