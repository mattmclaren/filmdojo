...
<!-- Mirrored from 7.pdvop2sz.z8.ru/highland/1.4/gallery-bubbles.php by HTTrack Website Copier/3.x [XR&CO'2013], Sat, 15 Mar 2014 23:21:41 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>The Highland Template - Gallery Condensed</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <h1 class="animated slideInLeft"><span>Gallery</span></h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="btn-group" id="filters">
            ...
            <a href="#" class="btn btn-default" data-filter=".cat-1"><span class="hidden-xs">Category</span> #1</a>
            <a href="#" class="btn btn-default" data-filter=".cat-2"><span class="hidden-xs">Category</span> #2</a>
            <a href="#" class="btn btn-default" data-filter=".cat-3"><span class="hidden-xs">Category</span> #3</a>
            <a href="#" class="btn btn-default" data-filter=".cat-4"><span class="hidden-xs">Category</span> #4</a>
          </div>
        </div>
      </div>
      <ul class="row list-inline gallery-list gallery-list-bubbles" id="isotope-container">
        <li class="isotope-item cat-1 cat-2 cat-4">
          <a href="gallery-item.php">
            <span class="gallery-thumbnail">
              <img class="img-responsive" src="img/works1.jpg" alt="...">
              <span class="gallery-bubble">
                <span class="pull-left">Image Title</span>
                <span class="pull-right">
                  <i class="fa fa-thumb-tack"></i> 12 <i class="fa fa-comments"></i> 5
                </span>
        ...
        <li class="isotope-item cat-2 cat-4">
          <a href="gallery-item.php">
            <span class="gallery-thumbnail">
              <img class="img-responsive" src="img/works2.jpg" alt="...">
              <span class="gallery-bubble">
                <span class="pull-left">Image Title</span>
                <span class="pull-right">
                  <i class="fa fa-thumb-tack"></i> 12 <i class="fa fa-comments"></i> 5
        ...
        <li class="isotope-item cat-3 cat-1">
          <a href="gallery-item.php">
            <span class="gallery-thumbnail">
              <img class="img-responsive" src="img/works3.jpg" alt="...">
              <span class="gallery-bubble">
                <span class="pull-left">Image Title</span>
                <span class="pull-right">
                  <i class="fa fa-thumb-tack"></i> 12 <i class="fa fa-comments"></i> 5
        ...
        <li class="isotope-item cat-2 cat-4">
          <a href="gallery-item.php">
            <span class="gallery-thumbnail">
              <img class="img-responsive" src="img/works4.jpg" alt="...">
              <span class="gallery-bubble">
                <span class="pull-left">Image Title</span>
                <span class="pull-right">
                  <i class="fa fa-thumb-tack"></i> 12 <i class="fa fa-comments"></i> 5
        ...
        <li class="isotope-item cat-1 cat-2">
          <a href="gallery-item.php">
            <span class="gallery-thumbnail">
              <img class="img-responsive" src="img/works3.jpg" alt="...">
              <span class="gallery-bubble">
        ...
        <li class="isotope-item cat-1 cat-4">
          <a href="gallery-item.php">
            <span class="gallery-thumbnail">
              <img class="img-responsive" src="img/works4.jpg" alt="...">
              <span class="gallery-bubble">
