...
<!-- Mirrored from 7.pdvop2sz.z8.ru/highland/1.4/gallery-item.php by HTTrack Website Copier/3.x [XR&CO'2013], Sat, 15 Mar 2014 23:21:41 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>The Highland Template - Gallery Item</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <h1 class="animated slideInLeft"><span>Gallery Item</span></h1>
          </div>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
            ...
            <div id="gallery-carousel" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <img src="img/works2_big.jpg" class="img-responsive" alt="...">
                </div>
                <div class="item">
                  <img src="img/works3_big.jpg" class="img-responsive" alt="...">
                </div>
                <div class="item">
                  <img src="img/works4_big.jpg" class="img-responsive" alt="...">
                </div>
              </div>
              <!-- Controls -->
              <a class="carousel-arrow carousel-arrow-prev" href="#gallery-carousel" data-slide="prev">
                <i class="fa fa-angle-left"></i>
              </a>
              <a class="carousel-arrow carousel-arrow-next" href="#gallery-carousel" data-slide="next">
        ...
        <div class="col-sm-4 col-md-3">
          <h3>Image Title</h3>
          <p>Nullam id ipsum varius, tincidunt odio nec, placerat enim. Sed sit amet auctor augue, nec dignissim ligula.</p>
          <hr>
...
<!-- Mirrored from 7.pdvop2sz.z8.ru/highland/1.4/gallery-item.php by HTTrack Website Copier/3.x [XR&CO'2013], Sat, 15 Mar 2014 23:21:43 GMT -->
</html>